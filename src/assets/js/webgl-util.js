...
ArcballCamera.prototype.eyePos = function(camera) {
...
var Shader = function(vertexSrc, fragmentSrc, gl) {
	var self = this;
	this.program = compileShader(vertexSrc, fragmentSrc, gl);
...
var compileShader = function(vert, frag, gl){
